...
public class GoldenRoyalGuardMovement extends Thread{
    ...
    public GoldenRoyalGuardMovement(Alien alienLabel, JLabel barraPerigo, Pilha pilha,JLabel contagemOnda) {
